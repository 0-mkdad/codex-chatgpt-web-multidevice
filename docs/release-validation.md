...
5. Configure the launcher-selected automatic connector (default `Codex Native2`), run **Verify
   runtime**, and complete one Full-mode local tool turn. Repeat with Pro when the account exposes Pro.
