...
const en = {
  ...
  savedAutomaticConnectorName: "Saved automatic connector",
...
const zh: Record<keyof typeof en, string> = {
  ...
  connectorName: "连接器名称",
  savedAutomaticConnectorName: "已保存的自动连接器",
  verifyRuntime: "验证运行时",
...
const ja: Record<keyof typeof en, string> = {
  ...
  connectorName: "コネクタ名",
  savedAutomaticConnectorName: "保存済みの自動コネクタ",
...
const ko: Record<keyof typeof en, string> = {
  ...
  savedAutomaticConnectorName: "저장된 자동 커넥터",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  connectorName: "連接器名稱",
  savedAutomaticConnectorName: "已儲存的自動連接器",
